...
import {
  require_jsx_runtime
} from "./chunk-3YC6FNW3.js";
import {
  __commonJS,
  __toESM,
  require_react
} from "./chunk-VL44HY2N.js";
...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React3 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState7 = React3.useState, useEffect6 = React3.useEffect, useLayoutEffect3 = React3.useLayoutEffect, useDebugValue = React3.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React3 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore = shim.useSyncExternalStore, useRef6 = React3.useRef, useEffect6 = React3.useEffect, useMemo5 = React3.useMemo, useDebugValue = React3.useDebugValue;
...
function getUrlScheme(url) {
  ...
  return (_b = (_a = /^[\x00-\x20]*([a-z][a-z\d+.\t\n\r-]*:)/i.exec(url)) == null ? void 0 : _a[1]) == null ? void 0 : _b.replace(/[\t\n\r]/g, "").toLowerCase();
}
...
function encode(obj, stringify = String) {
  ...
  for (const key in obj) {
    const val = obj[key];
    if (val !== void 0) (result || (result = new URLSearchParams())).set(key, stringify(val));
  }
...
function createHistory(opts) {
  ...
  return {
    ...
    _getBlockers: () => {
      var _a;
      return ((_a = opts.getBlockers) == null ? void 0 : _a.call(opts)) ?? [];
    }
  };
}
...
function createBrowserHistory(opts) {
  ...
  const createHref = (path) => normalizeHref((opts == null ? void 0 : opts.createHref) ? opts.createHref(path) : path);
  ...
  const queueHistoryAction = (isPush, destHref, state) => {
    const href = (opts == null ? void 0 : opts.createHref) ? createHref(destHref) : void 0;
  ...
  */
  constructor(options, getStoreConfig) {
    ...
    this.navigate = async ({ to, reloadDocument, href, publicHref, ...rest }) => {
      ...
      if (hrefScheme || reloadDocument) {
        if (to !== void 0 || !href) {
          ...
          href ?? (href = publicLocation.publicHref);
          publicHref ?? (publicHref = publicLocation.publicHref);
        }
    ...
    this.resolveRedirect = (redirect2) => {
      ...
      let scheme;
      if (protocolRelativePrefixRegex.test(href) || (scheme = getUrlScheme(href)) && !this.protocolAllowlist.has(scheme)) throw new Error(true ? `Redirect blocked: unsafe protocol in href "${href}". Allowed protocols: ${Array.from(this.protocolAllowlist).join(", ")}.` : "Redirect blocked: unsafe protocol");
...
async function documentNavigation(router, href, { replace, ignoreBlocker }) {
  ...
  if (isDangerousProtocol(href, router.protocolAllowlist)) {
    if (true) console.warn(`Blocked navigation to dangerous protocol: ${href}`);
    return;
  }
  if (!ignoreBlocker) {
  ...
  (_b = (_a = router.history)._ignoreNextBeforeUnload) == null ? void 0 : _b.call(_a, href);
...
// node_modules/seroval-plugins/dist/dev/web-CWqRG00W.js
  ...
  const atom = {
    ...
    subscribe(observerOrFn) {
      ...
      const e = effect(() => {
        ...
        else (_a = obs.next) == null ? void 0 : _a.call(obs, atom._snapshot);
      });
      return { unsubscribe: () => {
        e.stop();
      } };
...
function useSelector(source, selector = (s) => s, options) {
  ...
  const subscribe2 = (0, import_react5.useCallback)((handleStoreChange) => {
    const { unsubscribe } = source.subscribe(handleStoreChange);
    return unsubscribe;
  }, [source]);
  const getSnapshot = (0, import_react5.useCallback)(() => source.get(), [source]);
  return (0, import_with_selector.useSyncExternalStoreWithSelector)(subscribe2, getSnapshot, getSnapshot, selector, compare);
}
...
function resolveIsActive(location, next, activeOptions, basepath, isHydrated) {
  ...
  if ((activeOptions == null ? void 0 : activeOptions.exact) ? currentPath !== nextPath : !(currentPath.startsWith(nextPath) && (currentPath.length === nextPath.length || currentPath[nextPath.length] === "/"))) return false;
...
function useLinkProps(options, forwardedRef) {
  ...
  const [href, isActive] = useSelector(router.stores.location, selectLinkState, { compare: compareLinkState });
  ...
  const resolvedStateProps = functionalUpdate(isActive ? activeProps : inactiveProps, {}) ?? (isActive ? STATIC_ACTIVE_OBJECT : STATIC_EMPTY_OBJECT);
...
function getHrefOption(next, router, disabled) {
  ...
  if ((location.external || href !== location.publicHref) && isDangerousProtocol(href, router.protocolAllowlist)) {
    if (true) console.warn(`Blocked Link with dangerous protocol: ${href}`);
    return;
  }
  return href;
}
...
var Link = React$110.forwardRef((props, ref) => {
  ...
  return React$110.createElement(_asChild || "a", linkProps, children);
});
...
var RouteApi = class extends BaseRouteApi {
  ...
  */
  constructor({ id }) {
    ...
    this.Link = import_react7.default.forwardRef((props, ref) => {
      const fullPath = useRouter().routesById[this.id].fullPath;
      return (0, import_jsx_runtime7.jsx)(Link, {
        ref,
        from: fullPath,
        ...props
      });
...
function CatchNotFound(props) {
  ...
  if (isServer ?? router.isServer) {
    ...
    return (0, import_jsx_runtime8.jsx)(CatchBoundary, {
...
function DefaultGlobalNotFound() {
  return (0, import_jsx_runtime8.jsx)("p", { children: "Not Found" });
}
...
function SafeFragment(props) {
  return (0, import_jsx_runtime10.jsx)(import_jsx_runtime10.Fragment, { children: props.children });
}
...
function renderRouteNotFound(router, route, data) {
  if (!route.options.notFoundComponent) {
    if (router.options.defaultNotFoundComponent) {
      const notFoundElement2 = (0, import_jsx_runtime11.jsx)(router.options.defaultNotFoundComponent, { ...data });
    ...
    return (0, import_jsx_runtime11.jsx)(DefaultGlobalNotFound, {});
  }
  const notFoundElement = (0, import_jsx_runtime11.jsx)(route.options.notFoundComponent, { ...data });
...
function ScrollRestoration() {
  ...
  return (0, import_jsx_runtime12.jsx)(ScriptOnce, { children: script });
}
...
function renderPending(router, route) {
  ...
  const pendingElement = (0, import_jsx_runtime13.jsx)(PendingComponent, {});
...
var Match = React$112.memo(function MatchImpl({ routeId }) {
  const router = useRouter();
  if (isServer ?? router.isServer) return (0, import_jsx_runtime13.jsx)(MatchView, {
    router,
    match: router.stores.byRoute.get(routeId).get()
  });
  return (0, import_jsx_runtime13.jsx)(MatchView, {
    router,
...
function MatchView({ router, match }) {
  ...
  return (0, import_jsx_runtime13.jsxs)(route.isRoot ? route.options.shellComponent ?? SafeFragment : SafeFragment, { children: [(0, import_jsx_runtime13.jsx)(matchContext.Provider, {
    value: match.routeId,
    children: (0, import_jsx_runtime13.jsx)(ResolvedSuspenseBoundary, {
      fallback: pendingElement,
      children: (0, import_jsx_runtime13.jsx)(ResolvedCatchBoundary, {
        getResetKey: () => match,
        ...
        children: (0, import_jsx_runtime13.jsx)(ResolvedNotFoundBoundary, {
          fallback: (error) => {
            error.routeId ?? (error.routeId = match.routeId);
          ...
          children: resolvedNoSsr ? (0, import_jsx_runtime13.jsx)(ClientOnly, {
            fallback: pendingElement,
            children: (0, import_jsx_runtime13.jsx)(MatchInner, { match })
          }) : (0, import_jsx_runtime13.jsx)(MatchInner, { match })
        })
      })
    })
  }), (isServer ?? router.isServer) && ((_c = route.parentRoute) == null ? void 0 : _c.id) === rootRouteId && router.options.scrollRestoration ? (0, import_jsx_runtime13.jsx)(ScrollRestoration, {}) : null] });
}
var MatchInner = React$112.memo(function MatchInnerImpl({ match }) {
  ...
  const out = React$112.useMemo(() => {
    ...
    return Comp ? (0, import_jsx_runtime13.jsx)(Comp, {}, key) : (0, import_jsx_runtime13.jsx)(Outlet, {});
  }, [
    key,
  ...
  if (match.status === "error") {
    if (isServer ?? router.isServer) {
      const errorElement = (0, import_jsx_runtime13.jsx)((route.options.errorComponent ?? router.options.defaultErrorComponent) || ErrorComponent, {
        error: match.error,
        reset: void 0,
        info: { componentStack: "" }
      });
...
var Outlet = React$112.memo(function OutletImpl() {
  ...
  const nextMatch = (0, import_jsx_runtime13.jsx)(Match, { routeId: childRouteId });
  if (routeId === rootRouteId) return (0, import_jsx_runtime13.jsx)(React$112.Suspense, {
...
function Matches() {
  ...
  const inner = (0, import_jsx_runtime14.jsxs)(import_jsx_runtime14.Fragment, { children: [!(isServer ?? router.isServer) && (0, import_jsx_runtime14.jsx)(Transitioner, { t: React$114.useState()[1] }), (0, import_jsx_runtime14.jsx)(ResolvedSuspense, {
    fallback: pendingElement,
    children: (0, import_jsx_runtime14.jsx)(MatchesInner, {})
  })] });
  return router.options.InnerWrap ? (0, import_jsx_runtime14.jsx)(router.options.InnerWrap, { children: inner }) : inner;
}
function MatchesInner() {
  ...
  const matchComponent = routeId ? (0, import_jsx_runtime14.jsx)(Match, { routeId }) : null;
  return (0, import_jsx_runtime14.jsx)(matchContext.Provider, {
    value: routeId,
    children: router.options.disableGlobalCatchBoundary ? matchComponent : (0, import_jsx_runtime14.jsx)(CatchBoundary, {
      getResetKey: () => match,
      onCatch: true ? (error) => {
...
function useMatchRoute() {
  ...
  return React$114.useCallback((opts) => {
    ...
    useSelector(router.stores.resolvedLocation, (location) => location == null ? void 0 : location.href),
...
function RouterContextProvider({ router, children, ...rest }) {
  ...
  const provider = (0, import_jsx_runtime15.jsx)(routerContext.Provider, {
    value: router,
    children
  });
  if (router.options.Wrap) return (0, import_jsx_runtime15.jsx)(router.options.Wrap, { children: provider });
  return provider;
}
function RouterProvider({ router, ...rest }) {
  return (0, import_jsx_runtime15.jsx)(RouterContextProvider, {
    router,
    ...rest,
    children: (0, import_jsx_runtime15.jsx)(Matches, {})
  });
}
...
function Asset(asset) {
  ...
  switch (asset.tag) {
    case "title":
      return (0, import_jsx_runtime16.jsx)("title", {
        ...attrs,
        suppressHydrationWarning: true,
        children
      });
    case "meta":
      return (0, import_jsx_runtime16.jsx)("meta", {
        ...attrs,
        suppressHydrationWarning: true
      });
    case "link":
      return (0, import_jsx_runtime16.jsx)("link", {
        ...attrs,
    ...
    case "style":
      if (asset.inlineCss && (process.env.TSS_INLINE_CSS_ENABLED === "true" || process.env.TSS_INLINE_CSS_ENABLED === void 0 && isServer)) return (0, import_jsx_runtime16.jsx)(InlineCssStyle, {
        attrs,
        nonce,
        children
      });
      return (0, import_jsx_runtime16.jsx)("style", {
        ...attrs,
...
function Script({ attrs, children, preventScriptHoist }) {
  ...
  if (isServer ?? router.isServer) {
    if (attrs == null ? void 0 : attrs.src) {
      if (!preventScriptHoist) return (0, import_jsx_runtime16.jsx)("script", {
        ...attrs,
        suppressHydrationWarning: true
      });
      return (0, import_jsx_runtime16.jsx)("script", {
    ...
    if (typeof children === "string") return (0, import_jsx_runtime16.jsx)("script", {
      ...attrs,
      dangerouslySetInnerHTML: innerHTML,
      suppressHydrationWarning: true
    });
  ...
  if (dataScript && typeof children === "string") return (0, import_jsx_runtime16.jsx)("script", {
    ...attrs,
    suppressHydrationWarning: true,
    dangerouslySetInnerHTML: innerHTML
  });
  if (!hydrated) {
    if (attrs == null ? void 0 : attrs.src) return (0, import_jsx_runtime16.jsx)("script", {
      ...attrs,
      suppressHydrationWarning: true
    });
    if (typeof children === "string") return (0, import_jsx_runtime16.jsx)("script", {
...
function renderScripts(router, scripts) {
  ...
  return (0, import_jsx_runtime17.jsx)(import_jsx_runtime17.Fragment, { children: scripts.map((asset, i) => (0, import_react12.createElement)(Asset, {
    ...asset,
...
function HeadContent2(props) {
  ...
  return (0, import_jsx_runtime19.jsx)(import_jsx_runtime19.Fragment, { children: (hydrated ? tags.filter((tag) => {
    var _a2;
    return tag.tag !== "link" || ((_a2 = tag.attrs) == null ? void 0 : _a2[DEV_STYLES_ATTR]) !== true;
  }) : tags).map((tag) => (0, import_react14.createElement)(Asset, {
    ...tag,
